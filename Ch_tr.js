...
//! Aidé par Flavio Lourenco et Baptiste Houques
...
function choix(id) {
	...
	if (id == idTresor) {
		...
		msg('<br/><h3> Bravo, vous venez de trouvé Teemo en '+ compteur + ' essais!<br/><h3>');
...
//Si nous sommes sur la bonne ligne
            ...
            msg('<br><h3>Invocateur : "Teemo semble te regarder mefie toi! </h3>');
            caseTable.setAttribute('class', 'goodline');
            caseTable.setAttribute('onclick', '');

//Si nous sommes sur la bonne colonne
             ...
             msg('<br/><h3>Invocateur : "Il est juste devant toi !"</h3>')
             caseTable.setAttribute('class', 'goodcolonne');
             caseTable.setAttribute('onclick', '');
...
function initTab() {
	...
	monTableau[coordoneX][coordoneY] = "tresor";
	let tableau="<table id='cartedujeu'>";
